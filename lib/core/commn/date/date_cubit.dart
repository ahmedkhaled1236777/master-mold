...
class DateCubit extends Cubit<DateState> {
  ...
  String producthalldate = '${DateTime.now().year}-${DateTime.now().month>9?DateTime.now().month:"0${DateTime.now().month}"}-${DateTime.now().day>9?DateTime.now().day:"0${DateTime.now().day}"}';
 ...
 String month = date.month > 9 ? '${date.month}' : '0${date.month}';
  ...
  cleardates() {
   date1 = '${DateTime.now().year}-${DateTime.now().month}-${DateTime.now().day}';
   date2 = "اختر التاريخ";
   date3 = "التاريخ من";
   date4 = "التاريخ الي";
   ...
   date7 = "اختر التاريخ";
      ...
      producthalldate = '${DateTime.now().year}-${DateTime.now().month>9?DateTime.now().month:"0${DateTime.now().month}"}-${DateTime.now().day>9?DateTime.now().day:"0${DateTime.now().day}"}';
